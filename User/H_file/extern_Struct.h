...
typedef struct
{
    ...
    unsigned char ucBST_COM_RUN;

    unsigned char ucRelay_STATE;
    unsigned char ucPrechar_STATE;
...
typedef struct
{
        ...
        uint16_t ucBST_RUN_State;//Stand_alone;
...
#endif
#ifdef DC750V
        uint16_t DCAC_fault_1;
        uint16_t DCAC_fault_2;
        uint16_t DCAC_fault_3;
        uint16_t DCAC_fault_4;
        uint16_t DCAC_fault_5;
#endif
}MB_struct;

typedef union
{
    unsigned int Arr[sizeof(MB_struct)];
    MB_struct Word;
}MODBUS;
...
typedef struct
{
    ...
    uint16_t Inv_sequence;
    uint16_t Max_power;
    uint16_t DCAC_SW_fault;
    uint16_t DCAC_HW_fault;
    uint16_t reserv1;
    uint16_t reserv2;
    uint16_t reserv3;
} CAN_RX;
...
typedef struct
{
    ...
    uint16_t FC_reserv8;
    uint16_t FC_reserv9;
    uint16_t FC_reserv10;
    uint16_t FC_reserv11;
    uint16_t FC_reserv12;
    uint16_t FC_reserv13;
    uint16_t FC_reserv14;
    uint16_t FC_reserv15;
    uint16_t FC_reserv16;
    uint16_t FC_reserv17;
    uint16_t FC_reserv18;
    uint16_t FC_reserv19;
    uint16_t FC_reserv20;
    uint16_t FC_reserv21;
    uint16_t FC_reserv22;
    uint16_t FC_reserv23;
    uint16_t FC_reserv24;
    uint16_t FC_reserv25;
    uint16_t FC_reserv26;
    uint16_t FC_reserv27;
    uint16_t FC_reserv28;
    uint16_t FC_reserv29;
    uint16_t FC_reserv30;
    uint16_t FC_reserv31;
    uint16_t FC_reserv32;
} CAN_TX;
...
typedef union
{
    unsigned int Arr[sizeof(CAN_TX)+sizeof(CAN_RX)];
    struct
    {
